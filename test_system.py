...
TEST_AUDIO_PATH = Path(__file__).resolve().parent / "sample_test.wav"
TEST_VIDEO_PATH = Path(__file__).resolve().parent / "sample_test_video.mp4"
...
def test_fastapi_endpoints():
    print("\n--- Test 4: Testing FastAPI Endpoints (Audio & Video) ---")
...
if __name__ == "__main__":
    print("==================================================")
    print("Running Unified Audio-Visual Deepfake Test Suite")
    print("==================================================")
